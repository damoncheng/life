...
INSERT INTO `travel_photo_sendword` VALUES (1,'<h1>肥肥爱瘦瘦*^_^*</h1>','2017-04-26 15:30:08','2017-04-26 15:30:08',3),(2,'ff 好帅 ss 好丑','2017-04-26 15:30:18','2017-04-26 15:30:18',1),(3,'ff 好帅 ss 好丑','2017-04-26 15:31:05','2017-04-26 15:31:05',4),(4,'ff 好帅 ss 好丑','2017-04-26 15:31:06','2017-04-26 15:31:06',2),(6,'here is guang_dong zhu_hai','2017-04-30 01:57:07','2017-04-30 01:57:07',6),(7,'<h4 style=\"text-align: center;\">广州沙面建筑群 ——地铁1号线、6号线 &nbsp;黄沙站</h4><h5 style=\"text-align: left;\"><span style=\"font-weight: normal;\">广州沙面建筑群是<font color=\"#333333\">全国重点文物保护单位</font><span style=\"color: rgb(51, 51, 51); font-family: arial, 宋体, sans-serif; font-size: 14px; text-indent: 28px; background-color: rgb(255, 255, 255);\">，也是广州市第一批历史文化保护区</span><span style=\"color: rgb(51, 51, 51); font-family: arial, 宋体, sans-serif; font-size: 14px; text-indent: 28px; background-color: rgb(255, 255, 255);\">。沙面曾是中国唯一的租界人工岛，是旧中国半封建半殖民地的历史见证，也是近代西方建筑文化输入中国的一个重要窗口；目前是多个国家驻广州领事馆所在地和在穗（广州的别称）外国人的主要活动区域。沙面岛共有150多座欧洲风格建筑，是广州最具异国风情的欧洲建筑群！</span>这里文化底蕴浓厚，是一个可以了解当地人文历史的好地方；环境优美的沙面岛，也是一个可以着装复古之风拍照的最佳之地！</span></h5>','2017-05-04 06:10:38','2017-05-04 06:10:38',7);
...
-- Dump completed on 2017-05-08 17:23:09
